...
<body>
    ...
    <div class="container">
        ...
        <div id="side-nav-container" class="side-nav">
            ...
            <a class = "current" href="viewApplication.php" ><i class="fa-solid fa-clipboard-list"></i> Applications</a>
        ...
        <div class="main-body">
            ...
            <div class="sub-top-nav">
                ...
                <div>
                    ...
                    <a href="viewApplication.html" style="color: darkblue;"><b>Applications</b></a>
                </div>
            </div>

            <div class="page-info">
                <!-- <button class="general-button list-button" onclick="createPDF('print')">PDF</button> -->
                <div id="print">
                <br>
                ...
                <div class="sorting">
                    ...
                    <br>
                    <span>Sort Application Order</span>
                    <select name='sortOrder' id='sortOrder'>
                        <option value=0 selected>Ascending</option>
                        <option value=1>Descending</option>
                    </select>
                    <br>
                    <button type='button' class='blueSubmit' style="max-width:200px;" onclick="sortApplication()"> Sort Now </button>
                </div>
                <br>

                <table class="user-list" id="manager-applications-list">
                    <tr>
                        ...
                        <th>College</th>
                        <th>Date Applied</th>
                        <th>Action</th><!--Pending, Approved, Rejected-->
                    </tr>
